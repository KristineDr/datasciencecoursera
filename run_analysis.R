...
install.packages("magrittr")  # Install the package magrittr
library(magrittr)
...
names(TidyData)<-gsub("Gyr", "Gyroscope", names(TidyData))
...
names(TidyData)<-gsub("Time_Body", "TimeBody", names(TidyData))
